...
if __name__ == "__main__":
    ...
    if VERBOSE:
        ...
        if NORMALIZE:
            axs[0].set_ylabel("Normalized Current", fontsize=12)
        elif STANDARDIZE1 or STANDARDIZE2:
            axs[0].set_ylabel("Standardized Current", fontsize=12)
        else:
        ...
        if NORMALIZE:
            axs[1].set_ylabel("Normalized Voltage", fontsize=12)
        elif STANDARDIZE1 or STANDARDIZE2:
            axs[1].set_ylabel("Standardized Voltage", fontsize=12)
        else:
