...
ax2 = fig.add_subplot(311)  # v1
ax4 = fig.add_subplot(312)  # v2
ax6 = fig.add_subplot(313)  # I

#ax1.set_title("Reconstructed training data\nV1")
#ax1.plot(train_data["t"][-n_train:], reconstruct_data["v1"], label="reconstructed_v1", marker="o", markersize=1, linestyle="", color="r")
#ax1.plot(train_data["t"][-n_train:], train_data["v1"][-n_train:], label="train_v1", linewidth=0.8, color="k")
#
#ax3.set_title("V2")
#ax3.plot(train_data["t"][-n_train:], reconstruct_data["v2"], label="reconstructed_v2", marker="o", markersize=1, linestyle="", color="r")
#ax3.plot(train_data["t"][-n_train:], train_data["v2"][-n_train:], label="train_v2", linewidth=0.8, color="k")
#
#ax5.set_title("I")
#ax5.plot(train_data["t"][-n_train:], reconstruct_data["I"], label="reconstructed_I", marker="o", markersize=1, color="r")
#ax5.plot(train_data["t"][-n_train:], train_data["i"][-n_train:], label="train_I", linewidth=0.8, color="k")
...
ax6.plot(test_data["t"][-n_test:], forecast_data["I"], label="forecast_I", marker="o", markersize=1, color="r", linestyle="")
ax6.plot(test_data["t"][-n_test:], test_data["i"][-n_test:], label="test_I", linewidth=0.8, color="k")
